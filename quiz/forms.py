...
class QuestionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['question'].widget.attrs.update({'class' : 'w3-input w3-round', 'placeholder': 'Question', 'rows':5})
        ...
        self.fields['marks'].widget.attrs.update({'class' : 'w3-input w3-round w3-half', 'placeholder': 'marks'})
        self.fields['negative'].widget.attrs.update({'class' : 'w3-input w3-round w3-half', 'placeholder': 'negative'})